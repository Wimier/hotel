<template>
  <view class="register-container">
    ...
    <button 
      class="login-btn" 
      :class="{ 'btn-active': isReadyToRegister }" 
...
export default {
  data() {
    return {
      ...
      confirmPassword: '', // 确认密码单独拿出来做前端校验
      captchaImg: '',
      isAgree: false
    };
  },
...
<style scoped>
/* 复用登录页的样式 */
.register-container { min-height: 100vh; background-color: #ffffff; padding: 60rpx 50rpx; }
