...
<script>
	import { getComment, updateComment } from '@/api/comment.js'
		...
		methods: {
			...
			async handleUpdate() {
				if (this.form.content.length < 5) {
					return uni.showToast({ title: '评价内容不能少于5个字', icon: 'none' });
				}
...
<style scoped>
	.comment-detail-container { min-height: 100vh; background: #f8f9fb; padding: 24rpx; padding-bottom: 140rpx; }
	.info-card { background: #fff; border-radius: 20rpx; padding: 30rpx; margin-bottom: 24rpx; }
	.hotel-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 10rpx; }
	.hotel-name { font-size: 30rpx; font-weight: bold; color: #333; }
	.order-sn { font-size: 22rpx; color: #999; }
	.room-type { font-size: 24rpx; color: #666; }

	.section { background: #fff; border-radius: 20rpx; padding: 30rpx; margin-bottom: 24rpx; }
	.section-title { font-size: 28rpx; font-weight: bold; margin-bottom: 20rpx; color: #333; }
	.rate-box { display: flex; align-items: center; margin-bottom: 30rpx; }
	.score-text { margin-left: 20rpx; color: #ff9900; font-size: 28rpx; }
	
	.content-box { background: #fafafa; border-radius: 12rpx; padding: 20rpx; }
	.comment-input { width: 100%; height: 200rpx; font-size: 28rpx; }
	.word-count { display: block; text-align: right; font-size: 22rpx; color: #ccc; }
	...
	.delete-btn { position: absolute; top: -10rpx; right: -10rpx; width: 36rpx; height: 36rpx; background: rgba(0,0,0,0.5); color: #fff; border-radius: 50%; text-align: center; line-height: 32rpx; }
	.upload-btn { border: 2rpx dashed #ddd; display: flex; flex-direction: column; align-items: center; justify-content: center; }

	.reply-section { background: #fffbe6; border-radius: 20rpx; padding: 30rpx; border: 1rpx solid #ffe58f; }
	.reply-title { font-size: 26rpx; font-weight: bold; color: #856404; margin-bottom: 10rpx; }
	.reply-content { font-size: 26rpx; color: #856404; line-height: 1.6; }
	.reply-date { font-size: 22rpx; color: #999; margin-top: 10rpx; }

	.footer { position: fixed; bottom: 0; left: 0; width: 100%; padding: 20rpx 40rpx; background: #fff; box-sizing: border-box; }
	.submit-btn { background: #0086F6; color: #fff; border-radius: 44rpx; font-size: 30rpx; height: 88rpx; line-height: 88rpx; }
</style>